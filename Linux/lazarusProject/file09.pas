...
var i:integer;
begin
deletefile('./tmp/temp1');
deletefile('./tmp/temp1.pas');
deletefile('./tmp/temp1.o');
deletefile('./tmp/temp2');
deletefile('./tmp/temp2.pas');
deletefile('./tmp/temp2.o');
deletefile('./tmp/temp3');
deletefile('./tmp/temp3.pas');
deletefile('./tmp/temp3.o');
deletefile('./tmp/temp4');
deletefile('./tmp/temp4.pas');
deletefile('./tmp/temp4.o');
deletefile('./tmp/temp5');
deletefile('./tmp/temp5.pas');
deletefile('./tmp/temp5.o');
deletefile('./tmp/temp0.sh');
deletefile('./tmp/temp10');
deletefile('./tmp/temp10.pas');
deletefile('./tmp/temp10.o');
deletefile('./tmp/temp20');
deletefile('./tmp/temp20.pas');
deletefile('./tmp/temp20.o');
deletefile('./tmp/temp30');
deletefile('./tmp/temp30.pas');
deletefile('./tmp/temp30.o');
deletefile('./tmp/temp40');
deletefile('./tmp/temp40.pas');
deletefile('./tmp/temp40.o');
deletefile('./tmp/temp50');
deletefile('./tmp/temp50.pas');
deletefile('./tmp/temp50.o');
deletefile('./tmp/temp00.sh');
deletefile('./tmp/result.txt');
for i:=1 to max_test_number do begin
deletefile('./tmp/iii'+inttostr(i));
deletefile('./tmp/ooo'+inttostr(i));
deletefile('./tmp/rrr'+inttostr(i));
deletefile('./tmp/temp0'+inttostr(i)+'.sh');
deletefile('./tmp/iiii'+inttostr(i));
deletefile('./tmp/oooo'+inttostr(i));
deletefile('./tmp/rrrr'+inttostr(i));
deletefile('./tmp/temp00'+inttostr(i)+'.sh');
end;end;
end.
