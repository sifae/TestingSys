...
function Heap32ListNext(hSnapshot: THandle; var lphl: THeapList32): Boolean;

type
  THeap32ListFirst = function (hSnapshot: THandle; var lphl: THeapList32): Boolean stdcall;
  THeap32ListNext = function (hSnapshot: THandle; var lphl: THeapList32): Boolean stdcall;
